...
url = "https://rest-ww.telesign.com/v1/score/"
...
# In your production code, update account_lifecycle_event dynamically based on the relevant stage in the customer journey at which you are making this check.
...
# Create the payload
payload = f"account_lifecycle_event={account_lifecycle_event}"
